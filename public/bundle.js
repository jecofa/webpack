...
/***/ (function(module, exports, __webpack_require__) {
    ...
    */
    ...
    //                   REACT PURO
    var customElement = _react2.default.createElement("h1", null, "Hello Word");
    var anotherCustomElement = _react2.default.createElement(
        "h1",
        null,
        "It's working"
    );
    
    _reactDom2.default.render(anotherCustomElement, document.getElementById("app"));
    //ReactDOM.render(customElement, document.getElementById("app"));
    
    var array = [5, 50, 500];
    var ourNumber = array.find(function (number) {
        return number > 10;
    });
